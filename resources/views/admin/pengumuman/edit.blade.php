...
@section('content')
  ...
  <div class="flex items-center justify-between mb-6">
    <div>
      <h1 class="text-3xl font-semibold tracking-tight">Ubah Pengumuman</h1>
      <p class="text-gray-600 mt-1">Perbarui data pengumuman dengan benar.</p>
    </div>
  ...
  <div class="bg-white rounded-2xl shadow p-6">
    <form method="POST" action="{{ route('admin.pengumuman.update', $item) }}" class="space-y-6">
      @csrf
      @method('PUT')

      @include('admin.pengumuman._form', ['item' => $item])
