    ...
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">
                Kelola data guru, identitas kepegawaian, dan informasi kontak guru.
            </p>
        </div>
...
<div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
    <form id="searchGuruForm" method="GET" action="{{ route('admin.guru.index') }}">
        ...
        <div class="relative">
            ...
            <input type="text"
                   ...
                   name="q"
                   value="{{ $q }}"
                   placeholder="Cari nama, NIP, NUPTK, atau no HP..."
                   autocomplete="off"
                        ...
                        <tr class="transition hover:bg-gray-50">
                            ...
                            <td class="px-5 py-4">
                                ...
                                <div class="mt-1 text-xs text-gray-500 md:hidden">
                                    {{ $row->no_hp ?? 'No HP belum tersedia' }}
                                </div>
                            </td>
                            ...
                            <td class="sticky right-0 bg-white px-5 py-4">
                                <div class="flex flex-wrap items-center justify-center gap-2">
                                    <a href="{{ route('admin.guru.edit', $row) }}"
                                    ...
                                    <a href="{{ route('admin.guru.show', $row) }}"
                                       class="inline-flex items-center gap-1 rounded-lg border border-gray-300 bg-white px-3 py-1.5 text-xs font-semibold text-gray-700 transition hover:bg-gray-100">
                                        Detail
                                    </a>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td colspan="9" class="px-5 py-12 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <h3 class="text-sm font-semibold text-gray-700">Belum ada data guru</h3>
                                    <p class="mt-1 text-sm text-gray-500">
